...
export const deleteType = async (id) => {
    const {data} = await $authHost({method:'DELETE', url:'api/types/delete/'+id});
    return data;
}
...
export const deleteBrand = async (id) => {
    const {data} = await $authHost({method:'DELETE', url:'api/brands/delete/'+id});
    return data;
}

// Update бренд
export const updateBrand= async (id, body) => {
    const {data} = await $authHost({method:'PUT', url:`api/brands/update/${id}`, data: body});
    return data;
}

// Update type
export const updateType= async (id, body) => {
    const {data} = await $authHost({method:'PUT', url:`api/types/update/${id}`, data: body});
    return data;
}
...
export const createMoreProduct = async (products) => {
    const {data} = await $authHost.post('api/products/create/more-product', products)
    return data
}

// Выбрать товар
export const fetchProduct = async (productTypeId, productBrandId) => {
    const {data} = await $host.get('api/products/get-all', {params: {
...
export const fetchDeleteProduct = async (id) => {
    const {data} = await $authHost({method:'DELETE', url:`api/products/delete/${id}`});
    return data;
}

// Обновление товара
export const updateProduct = async (id, body) => {
    const {data} = await $authHost({method:'PUT', url:`api/products/update/${id}`, data: body});
    return data;
}

// Обновление отображения
export const updateDisplayProduct = async ({isDisplay, id}) => {
    const {data} = await $authHost.put('api/products/update-display', {isDisplay, id});
    return data;
}

//Работа с корзиной
export const addProductToBasket = async (product) => {
    const {data} = await $authHost.post('api/basket/products/add-product', product);
    return data;
}

//Работа с корзиной
export const changeCountProductBasket = async (data_action) => {
    const {data} = await $authHost.post('api/basket/products/change-count', data_action);
    return data;
}

export const getProductFromBasket = async () => {
    const {data} = await $authHost.get('api/basket/products/get-user-basket-product');
    return data;
}

export const deleteProductFromBasket = async (formdata) => {
    const {data} = await $authHost({method: "DELETE", url: `api/basket/products/delete`, data: formdata});
    return data;
}

//Поиск товара
export const getAllProductSearch = async (name) => {
    const {data} = await $host({method:'GET', url:`api/products/search-by-name/${name}`});
    return data;
}

// Удалить бренд 
export const deleteInfo = async (id) => {
    const {data} = await $authHost({method:'DELETE', url:'api/products/params/delete/'+id});
    return data;
}
...
export const deleteSizeApi = async (id) => {
    const {data} = await $authHost({method:'DELETE', url:'api/sizes/delete/'+id});
    return data;
}
...
export const deleteProductSizeApi = async (size) => {
    const {data} = await $authHost({method:'DELETE', url:'api/sizes/product/delete', data: size});
    return data;
}
...
export const deleteBadge = async (id) => {
    const {data} = await $authHost({method:'DELETE', url:'api/product-badge/delete/'+id});
    return data;
}